...
POLL_TICK_SECONDS: int = int(os.getenv("POLL_TICK_SECONDS", "60"))
POLL_JITTER_SECONDS: int = int(os.getenv("POLL_JITTER_SECONDS", "600"))
POLL_LOCK_TTL_SECONDS: int = int(os.getenv("POLL_LOCK_TTL_SECONDS", "300"))
POLL_FAILURE_BACKOFF_MAX_SECONDS: int = int(os.getenv("POLL_FAILURE_BACKOFF_MAX_SECONDS", "3600"))
...
LMS_HTTP_TIMEOUT_SECONDS: int = int(os.getenv("LMS_HTTP_TIMEOUT_SECONDS", "60"))
LMS_RETRY_ATTEMPTS: int = int(os.getenv("LMS_RETRY_ATTEMPTS", "2"))
LMS_RETRY_BACKOFF_SECONDS: float = float(os.getenv("LMS_RETRY_BACKOFF_SECONDS", "0.5"))
...
MIGRATION_BATCH_SIZE: int = int(os.getenv("MIGRATION_BATCH_SIZE", "500"))
